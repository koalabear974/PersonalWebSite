              ...
              <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu" role="menu">
                    ...
                    <li <?php if(basename($_SERVER['PHP_SELF'])=="embeddedSystems.php"){ echo 'class="active"';} ?>><?php $page="projects/embeddedSystems.php"; if($lang=="fr"){ echo '<a href="'.$page.'?lang=fr">Systèmes embarqués</a>';} else{echo '<a href="'.$page.'?lang=en">Embedded Systems</a>'; }?></li>
                    <li <?php if(basename($_SERVER['PHP_SELF'])=="virtualization.php"){ echo 'class="active"';} ?>><?php $page="projects/virtualization.php"; if($lang=="fr"){ echo '<a href="'.$page.'?lang=fr">Virtualisation</a>';} else{echo '<a href="'.$page.'?lang=en">Virtualization</a>'; }?></li>
                    <li <?php if(basename($_SERVER['PHP_SELF'])=="IS.php"){ echo 'class="active"';} ?>><?php $page="projects/IS.php"; if($lang=="fr"){ echo '<a href="'.$page.'?lang=fr">Systèmes d\'informations</a>';} else{echo '<a href="'.$page.'?lang=en">Information Systems</a>'; }?></li>
                    <li class="divider"></li>
                    <li class="dropdown-header"><?php if($lang=="fr"){ echo 'Projets Personnels';} else{echo 'Personal Projects'; }?></li>
                    <li <?php if(basename($_SERVER['PHP_SELF'])=="webAnimation.php"){ echo 'class="active"';} ?>><?php $page="projects/webAnimation.php"; if($lang=="fr"){ echo '<a href="'.$page.'?lang=fr">Animations JQuery</a>';} else{echo '<a href="'.$page.'?lang=en">Web Animations</a>'; }?></li>
                    <li <?php if(basename($_SERVER['PHP_SELF'])=="webcup2014.php"){ echo 'class="active"';} ?>><?php $page="projects/webcup2014.php"; if($lang=="fr"){ echo '<a href="'.$page.'?lang=fr">Webcup 2014</a>';} else{echo '<a href="'.$page.'?lang=en">Webcup 2014</a>'; }?></li>
                    <li <?php if(basename($_SERVER['PHP_SELF'])=="webcup2013.php"){ echo 'class="active"';} ?>><?php $page="projects/webcup2013.php"; if($lang=="fr"){ echo '<a href="'.$page.'?lang=fr">Webcup 2013</a>';} else{echo '<a href="'.$page.'?lang=en">Webcup 2013</a>'; }?></li>
                  </ul>
                </li>
              </ul>
